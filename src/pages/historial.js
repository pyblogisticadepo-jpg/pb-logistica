export async function renderHistorial(el, { supabase, currentUser }) {
  ...
  async function load() {
    ...
    // Cargar entregas (recorrido_pedidos entregados)
  ...
  function renderTable(lista) {
    ...
    wrap.innerHTML = `<table class="data-table">
      <thead><tr><th>Fecha</th><th>Cliente</th><th>Código</th><th>Tipo</th><th>Bultos</th><th>Operario</th><th>Hora</th><th>Recorrido</th><th></th></tr></thead>
      <tbody>${lista.map(p => `
        <tr>
